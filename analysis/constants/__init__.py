...
path_to_countries = '/Users/ozzy/PycharmProjects/matrixclusterisation/data/countries/{}.csv'

list_of_matrix = [pandas.read_csv(path_to_countries.format(country), index_col=0).loc[sectors, indicators].values
